\begin{tikzpicture}[scale=1.33, line width=0.6pt, every node/.style={ellipse, draw, fill=white}, >=latex]
    ...
    \node [fill=black!25] (obs) at (2, 2) {$\vec z_i$} edge [<-] (teff) edge [<-] (rad);
    ...
    \node (sig) at (1, 2) {$\sigma_i$} edge [->] (obs);
    ...
    \fill (3, 2) circle (1.5pt) edge [->] (obs) node[above, fill=none,draw=none] {$\vec\sigma_{z, i}$};
    \fill (2, 1) circle (1.5pt) edge [->] (obs) node[below, fill=none,draw=none] {$\nu_\delta, \vec\mu_\delta, \mat\Sigma_\delta, \mat A, \vec b$};

    \draw [decorate,decoration={brace,amplitude=4pt}]
    (4.66, 5.25) -- (4.66, 4.75) node[fill=none,draw=none,midway,right]{$\phi$};
    \draw [decorate,decoration={brace,amplitude=4pt}]
    (4.66, 4.25) -- (4.66, 3.75) node[fill=none,draw=none,midway,right]{$x_i$};
    \draw [decorate,decoration={brace,amplitude=4pt}]
    (4.66, 3.25) -- (4.66, 2.75) node[fill=none,draw=none,midway,right]{$\tilde{y}_i$};
